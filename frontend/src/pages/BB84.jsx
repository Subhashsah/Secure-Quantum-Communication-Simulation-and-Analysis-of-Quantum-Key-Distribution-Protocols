      ...
      <div className="bb84-content">
            ...
            <div className="controls-grid">
              ...
              <div className="control-group">
                <label htmlFor="bits" className="control-label">
                  <span className="label-text">Number of Bits</span>
              ...
              <div className="results-grid">
                <div className="result-card">
                  ...
                  <div className="result-content">
                    <p className="result-label">Sifted Bits</p>
                    <p className="result-value">{result.sifted_bits}</p>
                    <p className="result-description">
                      Bits where both used same basis
                    </p>
                  </div>
                </div>
        ...
        <div className="info-panel">
          <div className="info-card">
            <h3 className="info-title">About BB84</h3>
            <p className="info-text">
              The BB84 protocol is a quantum key distribution method that enables two parties
              to establish a shared secret key over a public channel, with security guaranteed
          ...
          <div className="info-card">
            ...
            <ul className="info-list">
              <li>Subhash generates random bits and bases</li>
              <li>David measures with random bases</li>
              <li>Public comparison of bases</li>
              <li>Sifted key formation</li>
              <li>QBER analysis for eavesdropping detection</li>
            </ul>
          </div>
          ...
          <div className="info-card">
            ...
            <dl className="info-definitions">
              <dt>Bits</dt>
              <dd>Initial quantum bits transmitted</dd>
              <dt>Noise</dt>
              <dd>Channel distortion level</dd>
              <dt>Eve</dt>
              <dd>Eavesdropper attack probability</dd>
            </dl>
          </div>
        </div>
      </div>
